...
<html lang="en">
  ...
  <body>
  	<div style="height: 60.61px;background: #666666;color: white;width: 100%;font-size: 15px;text-align: center;vertical-align: middle;line-height: 60.61px;">		体力測定アプリ管理画面
  	</div>
  	@yield('content')
